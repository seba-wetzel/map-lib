...
exports.sassTildeImporter = {
    findFileUrl: function (url) {
        ...
        var nodeModSubpath = path_1.default.join('node_modules', url.substring(1));
        ...
        if (nodeModSubpath.endsWith('.scss') ||
            ...
            // Look for .scss first.
            subpathsWithExts.push("".concat(nodeModSubpath, ".scss"), "".concat(nodeModSubpath, ".sass"), "".concat(nodeModSubpath, ".css"));
        }
        // Support index files.
        subpathsWithExts.push("".concat(nodeModSubpath, "/_index.scss"), "".concat(nodeModSubpath, "/_index.sass"));
        ...
        if (!basename.startsWith('_')) {
            var partials = subpathsWithExts.map(function (file) {
                return file.replace(basename, "_".concat(basename));
            });
        ...
        var prevDir = '';
        var dir = path_1.default.dirname(url);
        while (prevDir !== dir) {
